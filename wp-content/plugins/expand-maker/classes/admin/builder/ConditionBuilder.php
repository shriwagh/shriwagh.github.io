...
class ConditionBuilder {
	...
	public function render() {
		...
		$content = '<div class="yrm-conditions-wrapper" data-child-class="'.$childClassName.'">';
	...
	private function getConditionRowFromCurrentData($data, $currentIndex) {
		...
		$conditions = '<div class="yrm-condion-wrapper row" data-value-from-first="'.$valueFromFirst.'" data-condition-id="'.esc_attr($currentIndex).'">';
